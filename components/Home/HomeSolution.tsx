	...
	return (
		<div className="technology_solution">
			...
			<div className="technology_solution_button">
				<Link href="/lien-he"><div className="button_solution">THAM KHẢO GIẢI PHÁP</div></Link>
				<Link href="/lien-he"><div className="button_solution support_solution">YÊU CẦU HỖ TRỢ KỸ THUẬT</div></Link>
			</div>
